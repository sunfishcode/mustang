...
type_!(c_char, c_char);
type_!(c_schar, c_schar);
type_!(c_uchar, c_uchar);
type_!(c_short, c_short);
type_!(c_ushort, c_ushort);
type_!(c_int, c_int);
type_!(c_uint, c_uint);
type_!(c_long, c_long);
type_!(c_ulong, c_ulong);
type_!(c_longlong, c_longlong);
type_!(c_ulonglong, c_ulonglong);
type_!(c_float, c_float);
type_!(c_double, c_double);
